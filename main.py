        ...
        if content == trigger_prefix+"总结":
            ...
            def check(records):
                ...
                for record in records[::-1]:
                    ...
                    query += "\n\n"+sentence
                prompt = "你是一位群聊机器人，你需要对给出的聊天记录进行摘要，要求简明扼要，以包含列表的大纲形式输出，识别到说话人情绪请使用emoji表示。\n在聊天记录中，[x]是相应emoji表情或者是对图片和声音文件的说明，<>和""内分别是说话人名字和讲话内容。名字前面的(T)表示这条信息触发了群聊机器人的回复，内容是提问或使用指令触发某个功能，聊天记录中不包含你对这类消息的回复。\n"
